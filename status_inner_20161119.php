...
{
	$dateShift1a= date('Y-m-d 6:00', strtotime('-1 day'));
	$dateShift1b= date('Y-m-d 14:00', strtotime('-1 day'));
	$dateShift2a= date('Y-m-d 14:00', strtotime('-1 day'));
	$dateShift2b= date('Y-m-d 22:00', strtotime('-1 day'));
	$dateShift3a= date('Y-m-d 22:00', strtotime('-1 day'));
	$dateShift3b= date('Y-m-d 6:00', strtotime('+0 day'));	
}
else  //  6AM to 
{
	$dateShift1a= date('Y-m-d 6:00', strtotime('+0 day'));
	$dateShift1b= date('Y-m-d 14:00', strtotime('+0 day'));
	$dateShift2a= date('Y-m-d 14:00', strtotime('+0 day'));
	$dateShift2b= date('Y-m-d 22:00', strtotime('+0 day'));
	$dateShift3a= date('Y-m-d 22:00', strtotime('+0 day'));
	$dateShift3b= date('Y-m-d 6:00', strtotime('+1 day'));
}
...
//echo $date1." ".$date2."<br>";
		...
		{
			if ($process=='all'){
			$sql = "SELECT count (InventoryPack.InventoryPackNo)
...
function getTarget($process,$parent)
{
global $line;
global $desc;
...
getTarget($process,$parent);
$shift1Actual=getOuts($process,$parent,"Shift1");
$shift2Actual=getOuts($process,$parent,"Shift2");
$shift3Actual=getOuts($process,$parent,"Shift3");
